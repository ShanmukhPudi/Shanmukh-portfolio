...
export const PERSONAL = {
    ...
    email: "Shannu.pudi@outlook.com",
    location: "Visakhapatnam, Andhra Pradesh, India",
    github: "https://github.com/ShanmukhPudi",
    linkedin: "https://linkedin.com/in/shanmukh-pudi",
    resume: "/src/assets/ShanmukhKrishna_Frontend_Resume.pdf",
    available: true,
}
...
export const ABOUT = {
    bio: ["Hello! I'm Shanmukh, a Frontend Developer with 3+ years of production experience building the kind of software that people actually rely on - workflow systems, operations dashboards and data-driven interfaces that hold real businesses together. My stack is React, TypeScript and modern JavaScript, but what I actually sell is clarity: turning messy, manual processes into clean, fast, usable products.",
    "___________________________________________________________________________",
    "I owned 6+ production systems shipped independently as a sole architech and sole maintainer. That means I've designed component librarries, wired up REST APIs, and kept things running in production without a team to lean on.",
    "___________________________________________________________________________",
    "Right now I'm focused on growing as a Frontend developer - specifically in product companies where UI quality and user experience are taken seriously. If you care about what ships in the browser as much as what runs behind it, we'll get along just fine."],
      
    //   "Hey, I'm Shanmukh — a Software Engineer from Visakhapatnam, India, I started out wrangling Google Sheets and App Scripts, convincing spreadsheets to do things they were never meant to do, and somewhere along the way that turned into building full-on production systems.",
    ...
    strengths: [
        {
            ...
            description: "Built and maintained reusable, modular UI component libraries across multiple internal tools, reducing duplication, enforcing visual consistency and keeping frontend architecture scalable as product scope grew.",
        ...
        },
        {
            id: 2,
            icon: "🧱",
            title: "API Integration & Data Interfaces",
            description: "Proficient in connecting React frontends to REST APIs, real-time data rendering for lead tracking, workflow monitoring and performance dashboards.",
        ...
        },
        {
            id: 3,
            icon: "📊",
            title: "Workflow & Dashboard UIs",
            description: "Designed and developed form-heavy, workflow-driven interfaces. Built data-rich dashboards using Looker Studio and custom JS components to surface operational KPIs for decision-makers.",
        ...
        },
        {
            ...
            description: "End-to-end ownership of 6+ production systems, from architecture decisions to bug fixes and feature rollouts... independently. Not a team player by necessity, but by choice: I take full responsibility for what I ship.",
